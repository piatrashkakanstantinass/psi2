...
Figure \ref{deployment-diagram} showcases how the deployed applications look in the infrastructure. 
\begin{enumerate}
...
\begin{itemize}
    ...
    \item Azure PostgreSQL server
        \begin{itemize}
            ...
            \item 128 GB of storage
        \end{itemize}
    \item Azure Container Registry: A managed, private Docker registry service offered by Azure. It is used for React and .NET deployment. When a new image is uploaded webhook picks up the change and redeploys Azure Web App.
\end{itemize}
