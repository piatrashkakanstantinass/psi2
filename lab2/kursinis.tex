...
\hline
\multirow{2}{*}{\diagbox[dir=NW]{\textbf{Class}}{\textbf{Components}}} 
& \textbf{} & \textbf{} & \textbf{} & \textbf{} & \textbf{} & \textbf{} \\
& \textbf{Web} & \textbf{Notification System} & \textbf{Admin UI} & \textbf{OpenAI} & \textbf{API} & \textbf{Feedback} \\
& \textbf{} & \textbf{} & \textbf{} & \textbf{} & \textbf{} & \textbf{} \\
\hline
Conspectus & X & & & & & \\
\hline
...
\begin{tabular}{|c|c|c|c|c|c|c|}
\hline
\multirow{2}{*}{\diagbox[dir=NW]{\textbf{Requirements}}{\textbf{Components}}} 
& \textbf{} & \textbf{} & \textbf{} & \textbf{} & \textbf{} & \textbf{} \\
& \textbf{Web} & \textbf{Notification System} & \textbf{Admin UI} & \textbf{OpenAI} & \textbf{API} & \textbf{Feedback} \\
& \textbf{} & \textbf{} & \textbf{} & \textbf{} & \textbf{} & \textbf{} \\
\hline
