...
\begin{figure}[ht]
    \centering
    \includesvg[width=\textwidth]{../lab2diags/development-view/component_level1.drawio.svg}
    \label{Component level 1}
    \caption{Top level component diagram}
\end{figure}

\begin{description}
    \item[Description] Top level components of the system

\begin{figure}[ht]
    \centering
    \includesvg[width=\textwidth]{../lab2diags/development-view/component-level-2.drawio.svg}
