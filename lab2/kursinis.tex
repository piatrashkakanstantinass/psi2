...
\begin{figure}[ht]
    \centering
    \includesvg{../lab2diags/development-view/package.drawio.svg}
...
\begin{figure}[ht]
    \centering
    \includesvg{../lab2diags/development-view/component.drawio.svg}
    \label{Development diagram}
    \caption{Development diagram}
\end{figure}

\begin{description}
    \item[Description] Description of the development diagram
\end{description}
