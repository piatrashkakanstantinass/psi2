...
\begin{figure}[htbp]
    ...
    \begin{tabular}{|l|*{5}{c|}}
    \hline
    \backslashbox{Requirement}{Use Case} & \makecell{List \\ Quizzes} & \makecell{Take \\ Quiz} & \makecell{Delete \\ Quiz} & \makecell{Create \\ Quiz} & \makecell{Quiz Editor \\ Use Cases}\\ \hline
    FR1  & X & & & & \\ \hline
    FR2  & X & X & & & \\ \hline
    FR3  & & & X & X & X \\ \hline
    FR4  & & X & & &              \\ \hline
