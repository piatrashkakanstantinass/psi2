...
\begin{figure}[htbp]
    ...
    \backslashbox{Entity}{Use Case} & \makecell{List \\ Quizzes} & \makecell{Take \\ Quiz} & \makecell{Delete \\ Quiz} & \makecell{Create \\ Quiz} & \makecell{Edit \\ Quiz}\\ \hline
    User          & X & X & & & \\ \hline
...
\begin{figure}[htbp]
    ...
    \begin{tabular}{|l|*{5}{c|}}
    \hline
    \backslashbox{Requirement}{Use Case} & \makecell{List \\ Quizzes} & \makecell{Take \\ Quiz} & \makecell{Delete \\ Quiz} & \makecell{Create \\ Quiz} & \makecell{Edit \\ Quiz}\\ \hline
    FR1  & X & & & & \\ \hline
    FR2  & X & X & & & \\ \hline
    FR3  & & & X & X & X \\ \hline
    FR4  & & X & & &              \\ \hline
