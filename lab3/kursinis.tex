...
\begin{frlist}
    ...
    \item System shall only allow creation, editing and deletion of the topic quizzes to onwers of that topic.
    \item System shall support users taking the quiz.
    \item System shall check whether user answer is correct and display appropirate feedback.
...
\begin{figure}[htbp]
    ...
    \begin{tabular}{|l|*{5}{c|}}
    \hline
    Entity        & \makecell{List \\ Quizzes} & \makecell{Take \\ Quiz} & \makecell{Delete \\ Quiz} & \makecell{Create \\ Quiz} & \makecell{Edit \\ Quiz}\\ \hline
    User          & X & X & & & \\ \hline
    Topic Owner   & X & X & X & X & X \\ \hline
    Topic         & X & X & X & X & X \\ \hline
    Quiz          & X & X & X & X & X \\ \hline
    Question      & & X & X & X & X \\ \hline
    Option        & & X & X & X & X \\ \hline
    Quiz Session  & & X & & & \\ \hline
    User Answer   & & X & & & \\ \hline
    \end{tabular}
    \caption{Domain Entities to Use Cases Table}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{tabular}{|l|*{5}{c|}}
    \hline
    Requirement      & \makecell{List \\ Quizzes} & \makecell{Take \\ Quiz} & \makecell{Delete \\ Quiz} & \makecell{Create \\ Quiz} & \makecell{Edit \\ Quiz}\\ \hline
    FR1  & X & & & & \\ \hline
    FR2  & X & X & & & \\ \hline
    FR3  & & & X & X & X \\ \hline
    FR4  & & X & & &              \\ \hline
    ...
    FR13 & & & X & X & X \\ \hline
    NFR1 & & & & X & X \\ \hline
    NFR2 & X & X & X & X & X \\ \hline
    NFR3 & X & X & X & X & X\\ \hline
    NFR4 & X & X & X & X & X\\ \hline
    \end{tabular}
    \caption{Requirements to Use Cases Table}
\end{figure}
